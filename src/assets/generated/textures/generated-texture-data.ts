...
function txs<T>(tx: (data: TxData) => T) {
  return {
    Collectibles: {
      BallRed: tx({ id: "Collectibles.BallRed", atlas: 0, x: 1911, y: 272, width: 8, height: 8 }),
    },
    Font: {
      Diggit: tx({ id: "Font.Diggit", atlas: 0, x: 1986, y: 268, width: 54, height: 8 }),
    ...
    Fx: {
      ...
      Lump: tx({ id: "Fx.Lump", atlas: 0, x: 1865, y: 239, width: 62, height: 32 }),
      PopSmall: tx({ id: "Fx.PopSmall", atlas: 0, x: 1911, y: 282, width: 33, height: 11 }),
      Sparkle: tx({ id: "Fx.Sparkle", atlas: 0, x: 1865, y: 176, width: 18, height: 19 }),
      Swirl: tx({ id: "Fx.Swirl", atlas: 0, x: 1986, y: 277, width: 34, height: 42 }),
    },
    Home: {
      ...
      Cobweb: tx({ id: "Home.Cobweb", atlas: 0, x: 1865, y: 272, width: 45, height: 44 }),
      ...
      Poster: tx({ id: "Home.Poster", atlas: 0, x: 1997, y: 203, width: 48, height: 54 }),
      Shingles: tx({ id: "Home.Shingles", atlas: 0, x: 1865, y: 203, width: 66, height: 35 }),
      Tear: tx({ id: "Home.Tear", atlas: 0, x: 2035, y: 0, width: 8, height: 13 }),
    ...
    Player: {
      ...
      Penis: tx({ id: "Player.Penis", atlas: 0, x: 1997, y: 258, width: 6, height: 9 }),
    },
    Shapes: {
      Circle64: tx({ id: "Shapes.Circle64", atlas: 0, x: 1932, y: 203, width: 64, height: 64 }),
      LineVertical16: tx({ id: "Shapes.LineVertical16", atlas: 0, x: 2046, y: 0, width: 1, height: 16 }),
      Square32: tx({ id: "Shapes.Square32", atlas: 0, x: 1945, y: 282, width: 32, height: 32 }),
      Triangle128: tx({ id: "Shapes.Triangle128", atlas: 0, x: 1532, y: 171, width: 128, height: 128 }),
    },
    Terrain: {
      FishSkeleton: tx({ id: "Terrain.FishSkeleton", atlas: 0, x: 1819, y: 256, width: 45, height: 56 }),
      ...
      Grass3: tx({ id: "Terrain.Grass3", atlas: 0, x: 1928, y: 268, width: 57, height: 13 }),
    },
  };
}
